...
def calculate_mean_domain_sizes(key_1, nmin, nmax):
    ...
    df.columns = ['cmean', 'cstd', 'N_frac', 'percentage',  'bonding_type', 'csize']
    dg = df[df.csize>nmin]
    dg = dg[dg.csize<nmax]
...
if __name__ == "__main__":
    ...
    for delta in deltas:
        key_1 = 'mu_0.2Energy_-6.2symm_patchpos_{}'.format(delta)
        key_2 = 'mu_0.2Energy_-6.2symm_patchpos_{}'.format(1-delta)
