...
void pmove::Iso_Vol_Change(particles &Particles, box *Box, fileio &Fileio,
                           int mc_time) {
    ...
    if (b_factor >= XI) {
        ...
        for (int id = 0, id < Box->N; id++) {
            ...
            Particles.N_Particle[id].x_center =
                Particles.N_Particle[id].x_center -
                rint(Particles.N_Particle[id].x_center);
        ...
        do {
            ...
            id = id + 1;
            // cout<<"Before"<<endl;
            Particles.Collision_List_floppy[id].Calculate(
