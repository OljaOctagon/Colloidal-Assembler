...
void truncated_cube::edges_from_center() { // for truncated_cube aligned with
                                           // coordinate ax
...
void truncated_cube::Set_Start_Lattice_Position(int id, double box_Lx,
                                                int N_box) {
...
double
truncated_cube::Calculate_Projection_to_Separating_Axis(m_vector laxis) {
