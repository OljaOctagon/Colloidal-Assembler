...
def get_color(a,b,c,d):
			...
			# pink mixtures 
			# pink + yellow = salmon
			elif (c > 1/3. or d>1/3.) and b > 1/3.:
				cv = 2
			# pink + blue = pale purple
			elif (c > 1/3. or d>1/3.) and a > 1/3.:
				cv = 3
			# pink + rest = pale pink
			elif (c > 1/3. or d>1/3.) and a < 1/3. and b < 1/3.:
				cv = 1
				print(c,d)
			# blue mixtures 
			# blue + yellow = pale green
				...
				cv = 4
			# blue + rest = pale blue 
			elif a > 1/3. and b < 1/3. and (c < 1/3. or d<1/3.):
				cv = 5
			# yellow mixtures 
			# yellow + rest = pale yellow
			elif b > 1/3. and (c < 1/3. or d<1/3.) and a < 1/3.:
				cv = 6
...
plt.tight_layout()
plt.savefig("star_phase_diagram.pdf")
plt.show()
