...
def parse_config(directory,time_i):
    """returns positions, box lengths of max_checkpoint as arrays. """

    pos = np.fromfile("{}/{}_{}.bin".format(directory, 'positions', time_i))
    ...
    lbox = np.fromfile("{}/{}_{}.bin".format(directory, 'Box', time_i))
...
if __name__ == '__main__':
    ...
    for dir in dirlist:
        ...
        for time_i in range(max_cp-900,max_cp+100, 100):
            ...
            k+=1 
            # parse config
            pos, orient, boxl  = parse_config(dir,time_i)
            ...
            with open(dir+'/length_op.dat', 'a') as f:
                f.write(str(1000)+'\n')
                f.write("Particles of frame\n")
                for i in range(1000):
