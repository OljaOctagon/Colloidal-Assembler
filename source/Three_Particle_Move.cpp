...
void pmove::Three_Particle_Move(particles &Particles, box *Box, fileio &Fileio,
                                int mc_time) {
    ...
    Particles.Collision_List[id].Calculate_Bonds(Box, id, Particles.N_Particle,
    ...
    if (Particles.Collision_List[id].Nm >= 2) {
        ...
        Particles.Collision_List[id].Calculate_OP(
            ...
            Particles.MAX_coll_p);
        dU_old = Calculate_Pair_Potential(id, Particles, Box,
                                          Particles.Collision_List);

        Particles.Collision_List[list_id1].Calculate_OP(
            Box, list_id1, Particles.N_Particle,
            Particles.N_Particle[0]->cut_off, Particles.MAX_coll_p);
        dU_old = dU_old + Calculate_Pair_Potential(list_id1, Particles, Box,
                                                   Particles.Collision_List);

        Particles.Collision_List[list_id2].Calculate_OP(
            Box, list_id2, Particles.N_Particle,
            Particles.N_Particle[0]->cut_off, Particles.MAX_coll_p);
        dU_old = dU_old + Calculate_Pair_Potential(list_id2, Particles, Box,
                                                   Particles.Collision_List);
        ...
        scp1 =
        Particles.N_Particle[id]->long_axis.x*Particles.N_Particle[list_id1]->long_axis.x
        +
        ...
        scp2 =
        Particles.N_Particle[id]->long_axis.x*Particles.N_Particle[list_id2]->long_axis.x
        +
        ...
        */
        ...
        Particles.N_Particle[id]->phi =
            Particles.N_Particle[id]->phi + ((60.0 * M_PI) / 180.0);
        ...
        Particles.N_Particle[list_id1]->phi =
            Particles.N_Particle[list_id1]->phi + (60.0 * M_PI) / 180.0;

        if (Particles.N_Particle[list_id1]->phi > 2 * M_PI) {
            Particles.N_Particle[list_id1]->phi =
                Particles.N_Particle[list_id1]->phi - 2.0 * M_PI;
        }
        ...
        Particles.N_Particle[list_id2]->phi =
            Particles.N_Particle[list_id2]->phi + (60.0 * M_PI) / 180.0;

        if (Particles.N_Particle[list_id2]->phi > 2 * M_PI) {
            Particles.N_Particle[list_id2]->phi =
                Particles.N_Particle[list_id2]->phi - 2.0 * M_PI;
        }
        ...
        if (exit_status == 0) {
            ...
            dU_new = Calculate_Pair_Potential(id, Particles, Box,
                                              Particles.Collision_List);
            dU_new =
                dU_new + Calculate_Pair_Potential(list_id1, Particles, Box,
                                                  Particles.Collision_List);
            dU_new =
                dU_new + Calculate_Pair_Potential(list_id2, Particles, Box,
                                                  Particles.Collision_List);
            ...
            b_factor_pre = ((n1 * (n1 - 1)) / (n2 * (n2 - 1))) *
                           exp(-1.0 * beta * delta_U);
