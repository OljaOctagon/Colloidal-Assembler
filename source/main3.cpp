...
int main(int argc, char * argv[]){
		...
		particles Particles(Fileio.number_of_cells_in, Fileio.N_in, Fileio.MAX_coll_p_in, Fileio.MAX_fshell_p_in, Fileio.particle_type_in, Fileio.binary_on_in, Fileio.phi_binary_in);  
		...
		if(strcmp(runtype, new_runtype)==0){
			...
			Box->Startconfig(Fileio.N_in, Fileio.P_sigma_in, Fileio.mu_in, Fileio.packing_fraction_in, Particles.N_Particle[0]->V);
			start_time = 0;
