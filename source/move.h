...
move();
move(int size, int edge_length, double delta_tmax, double delta_rmax, double delta_Vmax, double Temperature, string is_translation_ON, string is_rotation_ON, string is_volumemove_ON, string is_grand_canonical_ON, string is_cluster_move_ON, int is_2D);
~move();
