...
tis_window::tis_window(int wv_0_in, int wv_i_in, int wv_ip1_in, int term_time,
...
void tis_window::Write_path_info(int N_check_points, int check_point_frequency,
                                 int mc_time) {
...
bool tis_window::tis_controller(int wv, int mc_time, int N_check_points,
    ...
    // if((is_proper_path
    // ==1)||(exceded_max_path_length==1)||(no_crossing_with_lambda_i==1)||(no_crossing_with_lambda_0==1)){
    if ((is_proper_path == 1) || (exceded_max_path_length == 1) ||
        (no_crossing_with_lambda_i == 1) || (no_crossing_with_lambda_0 == 1)) {
