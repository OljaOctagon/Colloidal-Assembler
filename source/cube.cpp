...
#include "cube.h"
   ...
   void cube::Set_Start_Lattice_Position(int id, double box_Lx, int N_box){
	...
	void cube::Set_Start_Lattice_Position(int id, double box_Lx, double box_Ly, double box_Lz, int N_box){
		...
		x_center = 0.5 + l_distpx/2.0 + double(id %N_sitespx + l_distpx*(id % N_sitespx));
		y_center = 0.5 + l_distpy/2.0 + double((id/N_sitespx)%N_sitespy + l_distpx*((id/N_sitespy)%N_sitespx)); 
		z_center = 0.5;
