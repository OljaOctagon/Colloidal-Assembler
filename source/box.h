...
void Startconfig(int N_in, double P_sigma_in, double mu_in, double packing_fraction_in, double V_p);
void Startconfig_former(int N_in, double P_sigma_in, double mu_in) ;
