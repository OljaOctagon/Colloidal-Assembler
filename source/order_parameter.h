...
class order_parameter {
  ...
  public:
    ...
    // Functions
    void Calculate_Local_Order_Parameters(particles &Particles,
                                          polyhedra **N_Particle, box *Box);
    void Calculate_2D_Psi(particles &Particles, box *Box);
    void Calculate_2D_Psi(int *List, int N_List, particles &Particles,
                          box *Box);
    ...
    void Calculate_Colors(int *List, int N_List, particles &Particles,
                          box *Box);
