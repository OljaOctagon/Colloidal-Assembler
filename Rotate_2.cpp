...
#include "move.h"
	...
	void move::Rotate( particles& Particles, box* Box, fileio& Fileio, int id, int mc_time){
		 ...
		 Rot_mat[0] = 1.0 - 2.0*Particles.N_Particle[id].q.y*Particles.N_Particle[id].q.y - 2.0*Particles.N_Particle[id].q.z*Particles.N_Particle[id].q.z;
		 Rot_mat[1] = 2.0*Particles.N_Particle[id].q.x*Particles.N_Particle[id].q.y - 2.0*Particles.N_Particle[id].q.w*Particles.N_Particle[id].q.z;
		 Rot_mat[2] = 2.0*Particles.N_Particle[id].q.x*Particles.N_Particle[id].q.z + 2.0*Particles.N_Particle[id].q.w*Particles.N_Particle[id].q.y;
			
		 Rot_mat[3] = 2.0*Particles.N_Particle[id].q.x*Particles.N_Particle[id].q.y + 2.0*Particles.N_Particle[id].q.w*Particles.N_Particle[id].q.z;
		 Rot_mat[4] = 1.0 - 2.0*Particles.N_Particle[id].q.x*Particles.N_Particle[id].q.x - 2.0*Particles.N_Particle[id].q.z*Particles.N_Particle[id].q.z;
		 Rot_mat[5] = 2.0*Particles.N_Particle[id].q.y*Particles.N_Particle[id].q.z - 2.0*Particles.N_Particle[id].q.w*Particles.N_Particle[id].q.x;
			
		 Rot_mat[6] = 2.0*Particles.N_Particle[id].q.x*Particles.N_Particle[id].q.z - 2.0*Particles.N_Particle[id].q.w*Particles.N_Particle[id].q.y;
		 Rot_mat[7] = 2.0*Particles.N_Particle[id].q.y*Particles.N_Particle[id].q.z + 2.0*Particles.N_Particle[id].q.w*Particles.N_Particle[id].q.x;
		 Rot_mat[8] = 1.0 - 2.0*Particles.N_Particle[id].q.x*Particles.N_Particle[id].q.x - 2.0*Particles.N_Particle[id].q.y*Particles.N_Particle[id].q.y;
